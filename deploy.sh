...
AI_QUEUE_URL="${AI_QUEUE_URL:-https://sqs.ap-south-1.amazonaws.com/105028893980/bug-daddy-ai-automation-queue}"
AI_QUEUE_WORKERS="${AI_QUEUE_WORKERS:-3}"
AI_QUEUE_DEFAULT_LENGTH="${AI_QUEUE_DEFAULT_LENGTH:-3}"
IDS_DATABASE_URL="${IDS_DATABASE_URL:-postgresql+psycopg2://sonar:DCjHsU0Rscm9gs08wAo1a390sqIN@bugdaddy-sonarqube-postgres.ctkcsksi0yjl.ap-south-1.rds.amazonaws.com:5432/app?sslmode=require}"
